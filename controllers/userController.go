...
import (
	helper "JWT-Authentication-with-go/helpers"
	models "JWT-Authentication-with-go/models"
	"context"
	"fmt"
	"log"
	"net/http"
	...
	"github.com/ilija-mihajlovic/JWT-Authentication-with-go/database"
...
func Signup() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if count > 0 {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "this email or phone number alredy exists"})
			return
		}
